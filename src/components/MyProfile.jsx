...
const MyProfile = () => {
  ...
  const profileImage = userProfile?.profileImage
    ? `http://localhost:5000${userProfile.profileImage}` // 🔧 fixed to show actual uploaded image
    : gender === "female"
    ? defaultFemale
    : defaultMale;
  ...
  const handleUpdate = async () => {
    if (!isEditing) {
      ...
      try {
        ...
        if (selectedFile) {
          formDataToSend.append("profileImage", selectedFile); // ✅ name fixed
        }
  ...
  return (
    <div className="myprofile w-full p-6">
      ...
      <div className="bg-white shadow-lg rounded-3xl flex flex-col md:flex-row items-center p-6 mb-8 gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-blue-100 p-6 rounded-2xl shadow-md mb-8">
